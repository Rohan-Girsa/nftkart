function Homeitemone() {
  return (
    <>
      <section className="flex items-center justify-center px-5 sm:px-[8.5%] md:px-[10%] lg:px-[12.5%] pb-3 sm:pb-14">
        <div className="flex flex-col sm:flex-row items-center justify-center">
          <section className="flex flex-col items-center justify-center py-3 sm:px-5 cursor-pointer hover:scale-105 ease-in-out">
            ...
            <div className="flex flex-col items-center justify-center w-[20rem] h-24 bg-[rgb(61,61,61)] hover:bg-[rgb(66,66,66)] rounded-b-lg">
          ...
          <section className="flex flex-col items-center justify-center py-3 sm:px-5 cursor-pointer hover:scale-105 ease-in-out">
            ...
            <div className="flex flex-col items-center justify-center w-[20rem] h-24 bg-[rgb(242,92,92)] rounded-b-lg">
              <h1 className="text-white text-2xl sm:font-semibold pb-2">
                Face
              </h1>
          ...
          <section className="flex flex-col items-center justify-center py-3 sm:px-5 cursor-pointer hover:scale-105 ease-in-out">
            ...
            <div className="flex flex-col items-center justify-center w-[20rem] h-24 bg-[rgb(61,61,61)] hover:bg-[rgb(59,59,59)] rounded-b-lg">
              <h1 className="text-white text-2xl sm:font-semibold pb-2">
                Mother Russia
              </h1>
