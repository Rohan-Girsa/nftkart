    ...
    <div className="flex flex-col items-center justify-center cursor-pointer py-3 sm:px-3">
      <div className="flex flex-col items-end justify-start relative">
        ...
        <img
          src={data.image}
          alt=""
          className="rounded-t-lg w-[14rem] h-80 sm:w-[20rem]"
        />
      </div>
      <div className="flex flex-col items-center justify-center w-[14rem] sm:w-[20rem] h-32 sm:h-12 bg-[rgb(53,53,53)] rounded-b-lg">
